  ...
  const handleSubmit = async (e) => {
    ...
    // Implement your logic to handle form submission
            ...
            try {
                ...
                const response = await axios.post('http://localhost:8000/api/product/create/65a294c44865e9f4138c7281', formData, {
                    headers: {
      ...
      <form onSubmit={handleSubmit}>
        <div className="form-left">
          ...
          >
            ...
            <option value="Bansai">Bansai</option>
